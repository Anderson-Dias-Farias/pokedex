...
import {
  useAppDispatch,
  useAppSelector,
} from "@/components/Store/pokemonSlice/useTypedSelector";
import {
  addPokemonM,
  remPokemonM,
  returnCorAtual,
...
import Evolutions from "./Eolution";
...
export default function Dialogs({
  ...
  const estacapturado = pk
    .filter((p) => (p.name === pokemon?.name ? p.favorit : null))
    .map((a) => a.favorit);
        ...
        >
          ...
          <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
            <div className="flex min-h-full justify-center p-4 text-center items-center ">
              ...
              >
                <Dialog.Panel className="relative mt-[20%] md:mt-20 transform overflow-hidden  text-gray-700 font-semibold rounded-lg py-10 px-3 bg-white shadow-xl transition-all w-full sm:max-w-7xl flex-col flex items-center justify-center">
                 ...
                 w-7 h-7 flex items-center justify-center border-gray-700  text-gray-700 "
                  ...
                  >
                    <Image
                      src={
                        capturado === true && estacapturado[0] == true
                          ? Pokebola
                          : PokebolaFundo
                      }
                      width={40}
